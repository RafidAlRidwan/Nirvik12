  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <h1 class="m-0">Donate Management</h1>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <!-- <ol class="breadcrumb float-sm-right">
          <a href={{URL::to('admin/donate/create')}}><button type="button" class="btn btn-primary">+ Add New</button></a>
        </ol> -->
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {{ Form::open(array('url' => 'admin/donate/destroy', 'id'=>'delete_form', 'method' => 'POST')) }}
        <div class="modal-body">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var table = $('#index_datatable').DataTable({
      ...
      "ajax": {
        "url": "{{URL::to('/admin/donate/getdata')}}",
        "type": "POST",
        "data": function(d) {
          $.extend(d, postData);
  ...
  $('#index_datatable').on('click', '.status', function() {
    var id = $(this).attr('id');
    $.ajax({
      url: "{{route('donate.status.modify')}}",
      type: "POST",
      data: {
        "_token": "{{ csrf_token() }}",
        "donate_id": id
