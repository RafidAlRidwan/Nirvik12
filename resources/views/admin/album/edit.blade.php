        ...
        <div class="row mb-2">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <ol class="breadcrumb float-sm-right">
                    <a href={{route('album_index')}}><button type="button" class="btn btn-primary">Back</button></a>
                </ol>
            </div>
        </div>
    </div>
          ...
          <input type="hidden" name="id" value={{$album->id}}>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value='{{$album->title}}' id="title" placeholder="" required>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="div-gap col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                ...
                <div class="tower-file">
                    <input type="hidden" name="image" id="image" value={{$album->attachment}}/>
