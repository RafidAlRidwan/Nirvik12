      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          @php
            ...
            $path = Request::path(); 
          @endphp
          <li class="<?php if( $path == 'user/dashboard'){ echo "menu-active"; }else{ echo ""; } ?>"><a href="{{URL::to('user/dashboard')}}">Dashboard</a></li>
          <li class="<?php if( $path == 'user/my-profile/show/'.$id){ echo "menu-active"; }else{ echo ""; } ?>"><a href="{{$url}}" class="">My Profile</a></li>
